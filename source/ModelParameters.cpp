...
namespace station_sim {
	...
	int ModelParameters::get_population_total() const
	{
	...
	float ModelParameters::get_gates_speed() const
	{
		return gates_speed;
	}
	...
	float ModelParameters::get_speed_min() const
	{
		return speed_min;
	}
	...
	float ModelParameters::get_speed_mean() const
	{
		return speed_mean;
	}
	...
	float ModelParameters::get_speed_std() const
	{
		return speed_std;
	}
	...
	int ModelParameters::get_speed_steps() const
	{
		return speed_steps;
	}
	...
	float ModelParameters::get_separation() const
	{
		return separation;
	}
	...
	float ModelParameters::get_max_wiggle() const
	{
		return max_wiggle;
	}
	...
	int ModelParameters::get_step_limit() const
	{
		return step_limit;
	}
	...
	bool ModelParameters::is_do_history() const
	{
		return do_history;
	}

	void ModelParameters::set_do_history(bool value)
	{
		this->do_history = value;
	}

	bool ModelParameters::is_do_print() const
	{
		return do_print;
	}

	void ModelParameters::set_do_print(bool value)
	{
		this->do_print = value;
	}

	int ModelParameters::get_random_seed() const
	{
		return random_seed;
	}

	void ModelParameters::set_random_seed(int value)
	{
		ModelParameters::random_seed = value;
	}
}
