...
namespace station_sim {
    ...
    void MultipleModelsRunMPI::add_model_and_model_parameters(Model model, ModelParameters model_parameters,
                                                              int model_index) {
...
#pragma omp parallel for schedule(static, 1) default(none)
    ...
    MultipleModelsRunMPI::~MultipleModelsRunMPI() { MPI_Finalize(); }

    int MultipleModelsRunMPI::get_mpi_world_size() const { return mpi_world_size; }

    int MultipleModelsRunMPI::get_mpi_world_rank() const { return mpi_world_rank; }
} // namespace station_sim
