...
TEST_CASE("Test help functions")
{
	...
	SECTION("Test linear_spaced_vector") {
		std::vector<float> result_1 = HelpFunctions::linear_spaced_vector(0, 3, 2);
		REQUIRE(result_1[0]==0);
		REQUIRE(result_1[1]==3);

//		std::vector<float> result_2 = linear_spaced_vector(3, 7, 2);
//		REQUIRE(result_2[0]==3);
//		REQUIRE(result_2[1]==5);
//
//		std::vector<float> result_3 = linear_spaced_vector(3, 1, 10);
//		REQUIRE(result_3.size()==0);
//
//		std::vector<float> result_4 = linear_spaced_vector(3, 7, -2);
//		REQUIRE(result_4.size()==0);
//
//		std::vector<float> result_5 = linear_spaced_vector(0.8394, 0.2, -0.2666);
//		REQUIRE(result_5[0]==Approx(0.8394));
//		REQUIRE(result_5[1]==Approx(0.5728f));
//		REQUIRE(result_5[2]==Approx(0.3062f));
	}
